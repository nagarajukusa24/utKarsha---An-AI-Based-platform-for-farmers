    ...
    <body>
        ...
        <!-- External CSS -->
                ...
                <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                        <tr>
                            <th>Farmer ID</th><th>Image Upload</th><th>Items</th><th></th>
                        </tr>
                       <?php 
                        $user_products_result=mysqli_query($con,$user_products_query) or die(mysqli_error($con));
                        $no_of_user_products= mysqli_num_rows($user_products_result);
                       ...
                       while($row=mysqli_fetch_array($user_products_result)){
                        ...
                        <tr>
                            ...
                            <th><a href='cart_remove.php?id=<?php echo $row['id'] ?>'>Request</a></th>
                        </tr>
                       <?php $counter=$counter+1;}?>
                        <tr>
                            <th></th><th>Total</th><th>Rs <?php echo $sum;?>/-</th><th></th><th><a href="success.php?id=<?php echo $user_id?>" class="btn btn-primary">Confirm Order</a></th>
                        </tr>
                    </tbody>
                </table>
            </div>
